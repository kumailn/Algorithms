...
| --- | --- | --- | --- | --- | --- |
| Plus One | 1 | [66](https://leetcode.com/problems/plus-one) | Easy | Array | [Python](Python/Plus_One.py) / [Go](Go/Plus_One.go) / [Dart](Dart/Plus_One.dart) / [Rust](Rust/Plus_One.rs) / [Javascript](Javascript/Plus_One.js) | 
