...
| Univalued Binary Tree | 965 | Easy | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/BST_Univalue.py) |
| Kth Smallest Element in a BST | 230 | Medium | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/BST_Kth_Smallest_Element.py) |
| Path Sum | 112 | Easy | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/Has_Path_Sum.py) |
| Minimum Depth of Binary Tree | 111 | Easy | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/BST_Min_Depth.py) |
| Sum Root to Leaf Numbers | 129 | Medium | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/Sum_Root_to_Leaf_Numbers.py) |
| Flatten Binary Tree to Linked List | 114 | Medium | Tree | [Python](https://github.com/kumailn/Algorithms/blob/master/Python/BT_Flatten_To.py) |
